...
namespace HotsapiUploader.Windows
{
    public partial class App : Application, INotifyPropertyChanged
    {
        ...
        public static Properties.Settings Settings { get { return HotsapiUploader.Windows.Properties.Settings.Default; } }
        ...
        public bool StartWithWindows
        {
            ...
            set {
                ...
                if (value) {
                    string command = $@"""{Directory.GetParent(AppDir)}\Update.exe"" --processStart HotsapiUploader.exe --process-start-args ""--autorun""";
